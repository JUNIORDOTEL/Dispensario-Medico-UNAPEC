...
@FacesConverter(value = "ubicacionesConverter")
public class UbicacionesConverter implements Converter {

    private UbicacionesFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Ubicaciones) {
            ...
            return getStringKey(o.getUbicacionID());
        } else {
    ...
    private UbicacionesFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(UbicacionesFacade.class).get();
